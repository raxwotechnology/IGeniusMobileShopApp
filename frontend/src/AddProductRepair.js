...
const API_URL = "https://igeniusmobileshopapp-5oi6.onrender.com/api/productsRepair";
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        ...
        const response = await fetch("https://igeniusmobileshopapp-5oi6.onrender.com/api/productsRepair");
        if (response.ok) {
    ...
    const fetchDeviceIssues = async () => {
      try {
        ...
        const response = await fetch("https://igeniusmobileshopapp-5oi6.onrender.com/api/deviceIssues");
        if (response.ok) {
          const data = await response.json();
    ...
    const fetchDeviceTypes = async () => {
      try {
        ...
        const response = await fetch("https://igeniusmobileshopapp-5oi6.onrender.com/api/deviceTypes");
        if (response.ok) {
          const data = await response.json();
          setDeviceTypes(data);
