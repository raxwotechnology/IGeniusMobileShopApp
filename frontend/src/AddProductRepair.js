  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        ...
        const response = await fetch("https://igeniusmobileshopapp-xagk.onrender.com/api/productsRepair");
        if (response.ok) {
    ...
    const fetchDeviceTypes = async () => {
      try {
        ...
        const response = await fetch("https://igeniusmobileshopapp-xagk.onrender.com/api/deviceTypes");
        if (response.ok) {
          const data = await response.json();
          setDeviceTypes(data);
